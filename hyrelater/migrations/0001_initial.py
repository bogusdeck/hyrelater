    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('phone_number', models.CharField(max_length=15)),
                ('employers', models.ManyToManyField(related_name='agencies', to='hyrelater.employer')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
            fields=[
                ...
                ('employer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='hyrelater.employer')),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
